...
shiinaDocs.initializeDocs();
        ...
        WebServer.post("/ap/user/badge/add", new dev.osunolimits.routes.ap.post.HandleBadgeAdd());
        WebServer.post("/ap/user/badge/delete", new dev.osunolimits.routes.ap.post.HandleBadgeDelete());
        WebServer.post("/ap/user/badge/move", new dev.osunolimits.routes.ap.post.HandleBadgeMove());
        WebServer.get("/badge/img/:name", new dev.osunolimits.routes.get.ServeBadge());
